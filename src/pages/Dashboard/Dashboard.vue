<template>
  <div class="dashboard-page">
    ...
    <b-row>
        <b-col xs="12">
          <Widget
            title="<h5>Patient <span class='fw-semi-bold'>Requests</span></h5>"
              ...
              <table class="table table-striped table-lg mb-0 requests-table">
                ...
                <tbody>
                  ...
                  >
                    ...
                    <td>{{row.date}}</td>
                    <td>{{row.city}}</td>
                    <b-button variant="default" @click="requestPermission(row)">Request</b-button>
                  </tr>
                </tbody>
              </table>
            </div>
      ...
      try {
        await fetch('https://fcm.googleapis.com/fcm/send', {
          ...
          headers: {
            ...
            'Authorization': 'key=AAAAgIRB51I:APA91bGEWRMqmaKV5uTOb5p4tqB81bb-hNSBcGC3n3r6R6QAHSnksOEhlcOEMGvmj2RWqg4fCrG1_6YqYk_MmQj4Q7VmHW83GNsA6US7okGVEI-FHETKUIHZ2rXi9SVV6M61C77-eQpG'
          },
          body: JSON.stringify({
            to: 'cihkwuBGToSklK0FDjIto9:APA91bFnBT915G8T3WeEixVxp3w-uVfNepHh2qM-ADGhOfaxtLifATGHm6iQPwBgp6e1QtdI_ZZVpJC5MABJ4PDp3WgxzZWz4JgtTmaHIQlCodBKxluqZQ5f31agqn9HM9grAt5fW9uA',
            notification: {
              title: `Hello ${row.name}!!`,
              body: `Please authorize access to your health records`
            }
          })
        })
    } catch (e) {
